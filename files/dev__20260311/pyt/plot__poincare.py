...
def plot__poincare( bpms_df=None, step=None, plot_conf={}  ):
    ...
    plots      = {
        "xp-px": {
            "config":{
                "figure.pngFile" :"png/poincare__impactx_xp-px_step{:06}.png".format( step ), \
                "ax1.x.label"    : "x (mm)", \
                "ax1.y.label"    : "x' (mrad)", \
        ...
        "yp-py": {
            "config":{
                "figure.pngFile"  :"png/poincare__impactx_yp-py_step{:06}.png".format( step ), \
                "ax1.x.label"     : "y (mm)", \
                "ax1.y.label"     : "y' (mrad)", \
                "ax1.x.range"     : { "auto":False, "min": -100.0, "max":100.0, "num":11 },
                "ax1.y.range"     : { "auto":False, "min": -100.0, "max":100.0, "num":11 },
        ...
        "tp-pt": {
            "config":{
                "figure.pngFile"  :"png/poincare__impactx_tp-pt_step{:06}.png".format( step ), \
                "ax1.x.label"     : "t (mm)", \
                "ax1.y.label"     : "t' (mrad)", \
                "ax1.x.range"     : { "auto":False, "min": -100.0, "max":100.0, "num":11 },
                "ax1.y.range"     : { "auto":False, "min": -100.0, "max":100.0, "num":11 },
        ...
        "dt-dE": {
            "config":{
                "figure.pngFile"  :"png/poincare__impactx_dt-dE_step{:06}.png".format( step ), \
                "ax1.x.label"     : "dt (ns)", \
                "ax1.y.label"     : "dE (MeV)", \

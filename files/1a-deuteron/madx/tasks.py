...
import nk_toolkit.madx.twiss__postProcess as tpp
...
def plot( c, surveyFile="out/survey.tfs", twissFile="out/twiss.tfs", html="out/plot.html" ):
    ...
    csvFile    = twissFile.replace( ".tfs", ".csv" )
    twiss      = tpp.twiss__postProcess( twiss=twiss, csvFile=csvFile )
...
# ===  all command                                      === #
# ========================================================= #
@invoke.task(pre=[clean, madx, plot])
def all(c):
    """all command"""    

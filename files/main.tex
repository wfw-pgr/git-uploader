...
% ===== 入力欄 =====
% 仕様書番号は YYMMDD-連番 形式を基本とする。例：260523-01
...
\BlockTitle{1.1 基本情報}
\begin{SpecTable}{|p{30mm}|p{50mm}|p{30mm}|p{50mm}|}
\hline
...
\BlockTitle{2.1 依頼範囲}
\begin{SpecTable}{|p{40mm}|p{24mm}|p{96mm}|}
\hline
...
\begin{itemize}
  \item その他依頼事項：記入。
  \item 対象外作業または別途手配がある場合は、本欄に明記すること。
  \item 支給品がある場合は、品名、数量、支給時期、返却要否を明記すること。
\end{itemize}
...
\BlockTitle{2.4 提示資料}
\begin{SpecTable}{|p{32mm}|p{58mm}|p{70mm}|}
\hline
